...
def find_employee_by_id():
    name = input( "Enter the employee's id: ")
    employee = Employee.find_by_id(name)
    print(employee) if employee  else print(
        f'Employee {name} not found')
    pass
...
def create_employee():
    ...
    department_id = input("Enter the employee's department_id: ")
    try:
...
def update_employee():
    ...
    if employee := Employee.find_by_id(id_):
        try:
            ...
            employee.name = name
            job_title = input("Enter the department's new location: ")
...
def list_department_employees():
    ...
    if employees:
        ...
        print(f"No employees found for department with ID {department_id}.")